...
const PLAYER_COMMAND_SHELL_ACTION_KEY = Object.freeze({
  ...
  // Blueprint §6 — additional route mappings
  rank: SHELL_ACTION_KEY.PLAYER_PVP_LEADERBOARD,
  inventory: SHELL_ACTION_KEY.PLAYER_REWARDS_PANEL,
  chests: SHELL_ACTION_KEY.PLAYER_REWARDS_PANEL,
  quests: SHELL_ACTION_KEY.PLAYER_TASKS_BOARD,
  news: SHELL_ACTION_KEY.PLAYER_EVENTS_HALL,
  invite: SHELL_ACTION_KEY.PLAYER_DISCOVER_CENTER,
  friends: SHELL_ACTION_KEY.PLAYER_DISCOVER_CENTER,
  share: SHELL_ACTION_KEY.PLAYER_DISCOVER_CENTER,
  history: SHELL_ACTION_KEY.PLAYER_PAYOUT_REQUEST
});
