...
const LiveOpsCampaignSelectionFamilyRiskDailyTrendPointSchema = z.object({
  day: z.string().default(""),
  risk_state: z.enum(["clear", "watch", "alert"]).default("clear"),
  risk_reason: z.string().default(""),
  risk_dimension: z.string().default(""),
  risk_bucket: z.string().default(""),
...
const LiveOpsCampaignSelectionAdjustmentDailyTrendPointSchema = z.object({
  day: z.string().default(""),
  adjustment_count: z.number().int().nonnegative().default(0),
  total_delta_sum: z.number().int().nonnegative().default(0),
  max_delta_value: z.number().int().nonnegative().default(0)
});
...
const LiveOpsCampaignOpsAlertSummarySchema = z.object({
  ...
  selection_family_escalation_band: z.enum(["clear", "watch", "alert"]).default("clear"),
  selection_family_escalation_reason: z.string().default(""),
  ...
  selection_field_family_weight: z.number().int().nonnegative().default(0),
  ...
  selection_field_family_match_days: z.number().int().nonnegative().default(0),
  selection_family_band_signal: z.string().default(""),
  selection_family_band_weight: z.number().int().nonnegative().default(0),
  selection_family_band_match_days: z.number().int().nonnegative().default(0),
  selection_family_band_state: z.string().default(""),
  selection_family_band_source: z.string().default(""),
  ...
  selection_latest_query_strategy_family: z.string().default(""),
  selection_latest_segment_strategy_reason: z.string().default(""),
  selection_latest_segment_strategy_family: z.string().default(""),
  selection_top_query_strategy_reason: z.string().default(""),
  selection_top_query_strategy_family: z.string().default(""),
  selection_top_query_strategy_reason_count: z.number().int().nonnegative().default(0),
  selection_top_segment_strategy_reason: z.string().default(""),
  selection_top_segment_strategy_family: z.string().default(""),
  selection_top_segment_strategy_reason_count: z.number().int().nonnegative().default(0),
  selection_query_adjustment_applied: z.boolean().default(false),
  selection_query_adjustment_count: z.number().int().nonnegative().default(0),
  selection_query_adjustment_total_delta: z.number().int().nonnegative().default(0),
  selection_query_adjustment_top_field: z.string().default(""),
  selection_query_adjustment_top_after_value: z.number().int().nonnegative().default(0),
  selection_query_adjustment_top_delta: z.number().int().default(0),
  selection_query_adjustment_top_direction: z.string().default(""),
  selection_query_adjustment_top_reason: z.string().default(""),
  selection_query_adjustment_escalation_band: z.enum(["clear", "watch", "alert"]).default("clear"),
  selection_query_adjustment_escalation_reason: z.string().default(""),
  selection_query_adjustment_escalation_dimension: z.string().default(""),
  selection_query_adjustment_escalation_bucket: z.string().default(""),
  selection_query_adjustment_escalation_field: z.string().default(""),
  selection_query_adjustment_escalation_score: z.number().int().nonnegative().default(0),
  selection_query_adjustment_daily_weight: z.number().int().nonnegative().default(0),
  selection_query_adjustment_total_delta_weight: z.number().int().nonnegative().default(0),
  selection_query_adjustment_top_delta_weight: z.number().int().nonnegative().default(0),
  selection_query_adjustment_field_weight: z.number().int().nonnegative().default(0),
  selection_query_adjustment_field_family: z.string().default(""),
  selection_query_adjustment_field_family_weight: z.number().int().nonnegative().default(0),
  selection_query_adjustment_query_family_match_days: z.number().int().nonnegative().default(0),
  selection_query_adjustment_segment_family_match_days: z.number().int().nonnegative().default(0),
  selection_query_adjustment_field_family_match_days: z.number().int().nonnegative().default(0),
  selection_query_adjustment_band_signal: z.string().default(""),
  selection_query_adjustment_band_weight: z.number().int().nonnegative().default(0),
  selection_query_adjustment_band_match_days: z.number().int().nonnegative().default(0),
  selection_query_adjustment_band_state: z.string().default(""),
  selection_query_adjustment_band_source: z.string().default(""),
...
const LiveOpsCampaignSelectionSummarySchema = z.object({
  guidance_mode: z.enum(["protective", "balanced", "aggressive"]).default("balanced"),
  guidance_state: z.enum(["clear", "watch", "alert"]).default("clear"),
  guidance_reason: z.string().default(""),
  focus_dimension: z.string().default(""),
  focus_bucket: z.string().default(""),
  focus_matches_target: z.boolean().default(false),
  prioritized_candidates: z.number().int().nonnegative().default(0),
  selected_candidates: z.number().int().nonnegative().default(0),
  prioritized_focus_matches: z.number().int().nonnegative().default(0),
  selected_focus_matches: z.number().int().nonnegative().default(0),
  prioritized_top_locale_matches: z.number().int().nonnegative().default(0),
  selected_top_locale_matches: z.number().int().nonnegative().default(0),
  ...
  query_strategy_summary: z.object({
    ...
    reason: z.string().default(""),
    strategy_family: z.string().default(""),
    mode_key: z.enum(["protective", "balanced", "aggressive"]).default("balanced"),
    segment_key: z.string().default(""),
    strategy_segment_path_key: z.string().default(""),
    adjustment_segment_path_key: z.string().default(""),
    focus_matches_target: z.boolean().default(false),
    dimension: z.string().default(""),
    bucket: z.string().default(""),
    exclude_locale_prefix: z.string().default(""),
    locale_strategy_reason: z.string().default(""),
    locale_strategy_family: z.string().default(""),
    segment_strategy_reason: z.string().default(""),
    segment_strategy_family: z.string().default(""),
    family_risk_state: z.enum(["clear", "watch", "alert"]).default("clear"),
    family_risk_reason: z.string().default(""),
    family_risk_dimension: z.string().default(""),
    family_risk_bucket: z.string().default(""),
    family_risk_match_days: z.number().int().nonnegative().default(0),
    family_risk_weight: z.number().int().nonnegative().default(0),
    family_risk_tightened: z.boolean().default(false),
...
const LiveOpsCampaignSelectionTrendSummarySchema = z.object({
  ...
  query_adjustment_applied_24h: z.number().int().nonnegative().default(0),
  query_adjustment_applied_7d: z.number().int().nonnegative().default(0),
  query_adjustment_total_delta_24h: z.number().int().nonnegative().default(0),
  query_adjustment_total_delta_7d: z.number().int().nonnegative().default(0),
  ...
  latest_query_strategy_family: z.string().default(""),
  latest_segment_strategy_reason: z.string().default(""),
  latest_segment_strategy_family: z.string().default(""),
  latest_query_strategy_segment_path: z.string().default(""),
  latest_query_adjustment_field: z.string().default(""),
  latest_query_adjustment_field_family: z.string().default(""),
  latest_query_adjustment_segment_path: z.string().default(""),
  latest_query_adjustment_reason: z.string().default(""),
  latest_query_adjustment_total_delta: z.number().int().nonnegative().default(0),
  latest_prefilter_reason: z.string().default(""),
  latest_family_risk_state: z.enum(["clear", "watch", "alert"]).default("clear"),
  latest_family_risk_reason: z.string().default(""),
  ...
  query_adjustment_query_family_daily_breakdown: z.array(LiveOpsCampaignSelectionFamilyDailyTrendPointSchema).default([]),
  segment_strategy_family_daily_breakdown: z.array(LiveOpsCampaignSelectionFamilyDailyTrendPointSchema).default([]),
  query_adjustment_segment_family_daily_breakdown: z.array(LiveOpsCampaignSelectionFamilyDailyTrendPointSchema).default([]),
  query_adjustment_field_family_daily_breakdown: z.array(LiveOpsCampaignSelectionFamilyDailyTrendPointSchema).default([]),
  query_strategy_segment_path_daily_breakdown: z.array(LiveOpsCampaignSelectionFamilyDailyTrendPointSchema).default([]),
  query_adjustment_segment_path_daily_breakdown: z.array(LiveOpsCampaignSelectionFamilyDailyTrendPointSchema).default([]),
  family_risk_daily_breakdown: z.array(LiveOpsCampaignSelectionFamilyRiskDailyTrendPointSchema).default([]),
  family_risk_field_family_band_daily_breakdown: z.array(LiveOpsCampaignSelectionFamilyDailyTrendPointSchema).default([]),
  family_risk_query_segment_path_band_daily_breakdown: z.array(LiveOpsCampaignSelectionFamilyDailyTrendPointSchema).default([]),
  family_risk_adjustment_segment_path_band_daily_breakdown: z.array(LiveOpsCampaignSelectionFamilyDailyTrendPointSchema).default([]),
  query_adjustment_field_breakdown: z.array(KpiLiveOpsCampaignBreakdownSchema).default([]),
  query_adjustment_field_family_breakdown: z.array(KpiLiveOpsCampaignBreakdownSchema).default([]),
  query_adjustment_reason_breakdown: z.array(KpiLiveOpsCampaignBreakdownSchema).default([]),
  ...
  query_adjustment_query_family_breakdown: z.array(KpiLiveOpsCampaignBreakdownSchema).default([]),
  ...
  query_strategy_segment_path_breakdown: z.array(KpiLiveOpsCampaignBreakdownSchema).default([]),
  query_adjustment_segment_path_breakdown: z.array(KpiLiveOpsCampaignBreakdownSchema).default([]),
...
module.exports = {
  ...
  LiveOpsCampaignSelectionSummarySchema,
