  ...
  return {
    ...
    selection_summary: {
      ...
      query_strategy_summary: {
        ...
        strategy_segment_path_key: String(selectionSummary.query_strategy_summary?.strategy_segment_path_key || ""),
        adjustment_segment_path_key: String(selectionSummary.query_strategy_summary?.adjustment_segment_path_key || ""),
    ...
    selection_trend: {
      ...
      latest_query_strategy_segment_path: String(selectionTrend.latest_query_strategy_segment_path || ""),
      ...
      latest_query_adjustment_segment_path: String(selectionTrend.latest_query_adjustment_segment_path || ""),
      ...
      latest_family_risk_query_segment_path: String(selectionTrend.latest_family_risk_query_segment_path || ""),
      latest_family_risk_adjustment_segment_path: String(selectionTrend.latest_family_risk_adjustment_segment_path || ""),
      ...
      family_risk_daily_breakdown: Array.isArray(selectionTrend.family_risk_daily_breakdown)
        ? selectionTrend.family_risk_daily_breakdown
            .map((row) => ({
              ...
              query_segment_path: String(row?.query_segment_path || ""),
              adjustment_segment_path: String(row?.adjustment_segment_path || ""),
      ...
      query_strategy_segment_path_breakdown: normalizeBreakdownRows(selectionTrend.query_strategy_segment_path_breakdown),
      query_adjustment_segment_path_breakdown: normalizeBreakdownRows(selectionTrend.query_adjustment_segment_path_breakdown),
      ...
      family_risk_query_segment_path_breakdown: normalizeBreakdownRows(selectionTrend.family_risk_query_segment_path_breakdown),
      family_risk_adjustment_segment_path_breakdown: normalizeBreakdownRows(selectionTrend.family_risk_adjustment_segment_path_breakdown),
      family_risk_field_family_band_breakdown: normalizeBreakdownRows(selectionTrend.family_risk_field_family_band_breakdown),
      family_risk_query_segment_path_band_breakdown: normalizeBreakdownRows(selectionTrend.family_risk_query_segment_path_band_breakdown),
      family_risk_adjustment_segment_path_band_breakdown: normalizeBreakdownRows(selectionTrend.family_risk_adjustment_segment_path_band_breakdown),
    ...
    return {
      ...
      selection_summary: {
        ...
        query_strategy_summary: {
          ...
          mode_key: "balanced",
          segment_key: "",
          strategy_segment_path_key: "",
          adjustment_segment_path_key: "",
          focus_matches_target: false,
          dimension: "",
          bucket: "",
      ...
      selection_trend: {
        ...
        latest_query_strategy_segment_path: "",
        latest_query_adjustment_field: "",
        latest_query_adjustment_field_family: "",
        latest_query_adjustment_segment_path: "",
