...
function buildEmptyLiveOpsOpsAlertSummary() {
  return {
    ...
    selection_family_band_signal: "",
    selection_family_band_weight: 0,
    selection_family_band_match_days: 0,
    selection_family_band_state: "",
    selection_family_band_source: "",
    ...
    selection_query_adjustment_band_signal: "",
    selection_query_adjustment_band_weight: 0,
    selection_query_adjustment_band_match_days: 0,
    selection_query_adjustment_band_state: "",
    selection_query_adjustment_band_source: "",
    telegram_sent: false,
    telegram_reason: "",
...
function readLatestOpsAlertArtifactSummaryFromDisk(now, repoRootDir) {
  ...
  try {
    ...
    return {
      ...
      selection_family_band_signal: String(evaluation.selection_family_band_signal || "").trim(),
      selection_family_band_weight: Math.max(0, Number(evaluation.selection_family_band_weight || 0)),
      selection_family_band_match_days: Math.max(0, Number(evaluation.selection_family_band_match_days || 0)),
      selection_family_band_state: String(evaluation.selection_family_band_state || "").trim(),
      selection_family_band_source: String(evaluation.selection_family_band_source || "").trim(),
      ...
      selection_query_adjustment_band_signal: String(evaluation.selection_query_adjustment_band_signal || "").trim(),
      selection_query_adjustment_band_weight: Math.max(0, Number(evaluation.selection_query_adjustment_band_weight || 0)),
      selection_query_adjustment_band_match_days: Math.max(0, Number(evaluation.selection_query_adjustment_band_match_days || 0)),
      selection_query_adjustment_band_state: String(evaluation.selection_query_adjustment_band_state || "").trim(),
      selection_query_adjustment_band_source: String(evaluation.selection_query_adjustment_band_source || "").trim(),
