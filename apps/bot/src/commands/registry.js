...
const RAW_COMMAND_REGISTRY = Object.freeze([
  ...
  { key: "checkin", aliases: ["bonus", "dailybonus"], description_tr: "Gunluk NXT bonus — streak carpani ile her gun NXT kazan (50-300 NXT)", description_en: "Daily NXT bonus — earn NXT every day with streak multiplier (50-300 NXT)", intents: ["checkin", "check in", "gunluk bonus", "daily bonus", "bonus al", "streak bonus", "nxt bonus"], scenarios: ["/checkin", "gunluk bonus", "daily nxt"], outcomes: ["streak hesapla", "NXT odul ver", "streak milestone goster"], primary: true },
  { key: "withdraw", aliases: ["nxtcek"], description_tr: "NXT cek — oyun icindeki NXT tokenleri gercek TON cuzdanina transfer et", description_en: "Withdraw NXT — transfer in-game NXT tokens to real TON wallet", intents: ["nxt cek", "nxt withdraw", "jetton gonder", "nxt transfer"], scenarios: ["/withdraw 500 EQD...", "/withdraw 100 <adres>", "nxt cek"], outcomes: ["bakiyeden NXT dusur", "gercek jetton gonder", "tx hash ile konfirme et"] },
  { key: "slot", aliases: ["slots", "makine"], description_tr: "NXT slot makinesi — bahis koy, 3 cark cevir, x25'e kadar kazan", description_en: "NXT slot machine — place bet, spin 3 reels, win up to x25", intents: ["slot", "slots", "slot machine", "makine", "kumar", "gamble", "spin"], scenarios: ["/slot 100", "/slot 50", "slot cevir"], outcomes: ["NXT bahis al", "3 cark cevir", "odeme tablosuna gore odul ver"], primary: true },
  { key: "tournament", aliases: ["turnuva"], description_tr: "NXT turnuva — giris ucreti ode, havuzdan odul kazan", description_en: "NXT tournament — pay entry fee, win from prize pool", intents: ["tournament", "turnuva", "yarisma", "competition"], scenarios: ["/tournament", "/tournament join", "turnuvaya katil"], outcomes: ["aktif turnuva goster", "giris ucreti ile katil", "havuzdan odul dagit"] },
  { key: "lootbox", aliases: ["kutu", "box"], description_tr: "NXT loot box — Bronze/Silver/Gold kutu ac, NXT odul kazan", description_en: "NXT loot box — open Bronze/Silver/Gold boxes, win NXT rewards", intents: ["lootbox", "loot box", "kutu", "box", "kutu ac", "kasa ac"], scenarios: ["/lootbox bronze", "/lootbox gold", "kutu ac"], outcomes: ["NXT ile kutu satin al", "rastgele odul ac", "house edge ile kazanc dagit"] },
  { key: "flip", aliases: ["yazitura", "coin"], description_tr: "Yazi tura — heads/tails sec, x1.96 kazanc", description_en: "Coin flip — pick heads/tails, win x1.96", intents: ["flip", "yazi tura", "coin flip", "coin", "yazitura"], scenarios: ["/flip heads 100", "/flip tails 50"], outcomes: ["bahis al", "yazi/tura cevir", "x1.96 kazanc veya kayip"] },
  { key: "crash", aliases: [], description_tr: "Crash oyunu — carpan yukselir, hedef belirle, patlamadan once kazan", description_en: "Crash game — multiplier rises, set target, win before crash", intents: ["crash", "crash game", "patlama", "carpan"], scenarios: ["/crash 100", "/crash 200 3.5", "crash oyna"], outcomes: ["bahis al", "crash noktasi hesapla", "hedef carpana ulasilirsa odul ver"] },
  { key: "stake", aliases: ["staking", "kilitle"], description_tr: "NXT staking — NXT kilitle, gunluk %0.5 faiz kazan", description_en: "NXT staking — lock NXT, earn 0.5% daily interest", intents: ["stake", "staking", "kilitle", "faiz", "pasif gelir"], scenarios: ["/stake 1000", "/stake 5000 30", "/unstake"], outcomes: ["NXT kilitle", "faiz hesapla", "sure dolunca geri al"] },
  { key: "battlepass", aliases: ["bp", "battle", "pass"], description_tr: "Battle Pass — sezonluk seviye ilerlemesi, ucretsiz + premium odul yolu", description_en: "Battle Pass — seasonal level progression, free + premium reward track", intents: ["battlepass", "battle pass", "bp", "pass", "sezon pass", "season pass"], scenarios: ["/battlepass", "/battlepass claim 5", "/battlepass premium"], outcomes: ["aktif sezonu goster", "seviye odullerini claim et", "premium'a yukselt"] },
  { key: "predict", aliases: ["tahmin"], description_tr: "TON fiyat tahmini — 5dk icinde yukselir/duser bahsi, x1.8 kazanc", description_en: "TON price prediction — 5min up/down bet, x1.8 payout", intents: ["predict", "tahmin", "fiyat tahmini", "prediction", "up down"], scenarios: ["/predict up 100", "/predict down 50"], outcomes: ["bahis al", "5dk sonra oracle fiyat karsilastir", "dogru tahmine x1.8 odul"] },
  { key: "clan", aliases: ["guild", "lonca"], description_tr: "Clan/Guild sistemi — kur, katil, bagis yap, liderlik tablosunda yaris", description_en: "Clan/Guild system — create, join, donate, compete on leaderboard", intents: ["clan", "guild", "lonca", "takim"], scenarios: ["/clan create Nexus NXW", "/clan join NXW", "/clan top", "/clan donate 500"], outcomes: ["clan kur ve yonet", "uye katil/ayril", "hazine bagisla", "top clan siralamasi"] },
  { key: "sell", aliases: ["sat"], description_tr: "NXT sat — P2P pazar emri olustur", description_en: "Sell NXT — create P2P market order", intents: ["sell", "sat", "satis", "nxt sat", "emir"], scenarios: ["/sell 1000 1200", "/sell 500 600"], outcomes: ["NXT escrow et", "satis emri olustur"] },
  { key: "buy", aliases: ["satin"], description_tr: "NXT al — P2P pazar emirlerini gor ve satin al", description_en: "Buy NXT — view P2P orders and purchase", intents: ["buy", "satin al", "nxt al", "pazar"], scenarios: ["/buy", "/buy 42"], outcomes: ["acik emirleri listele", "emri satin al"] },
  { key: "orders", aliases: ["emirler"], description_tr: "Pazar emirlerim — acik emirleri gor ve iptal et", description_en: "My market orders — view and cancel open orders", intents: ["orders", "emirler", "emirlerim", "my orders"], scenarios: ["/orders", "/orders cancel 42"], outcomes: ["emirleri listele", "emri iptal et ve NXT iade al"] },
  { key: "stats", aliases: ["istatistik", "profil2"], description_tr: "Oyuncu istatistikleri — seviye, XP, oyun sayilari, kazanc/kayip, clan", description_en: "Player stats — level, XP, game counts, win/loss, clan info", intents: ["stats", "istatistik", "oyun istatistigi", "my stats", "game stats"], scenarios: ["/stats", "istatistiklerim"], outcomes: ["seviye ve XP goster", "oyun bazli kazanc/kayip", "toplam NXT kazanc"] },
  { key: "achievements", aliases: ["basarim", "basarimlar"], description_tr: "Basarim galerisi — XP, seviye ve acilan basarimlar", description_en: "Achievement gallery — XP, level and unlocked achievements", intents: ["achievements", "basarim", "basarimlar", "badge", "rozet", "xp", "level", "seviye"], scenarios: ["/achievements", "basarimlarim", "seviyem"], outcomes: ["basarim listesini goster", "XP ve seviye durumunu belirt"] },
  ...
  { key: "admin_config", aliases: [], description_tr: "Oyun config — runtime game parametrelerini goruntule ve degistir", description_en: "Game config — view and update runtime game parameters", intents: ["admin config", "game config"], adminOnly: true },
  { key: "admin_event", aliases: [], description_tr: "Bonus event — 2x NXT, 2x XP veya yarim house fee tetikle", description_en: "Bonus event — trigger 2x NXT, 2x XP or half house fee", intents: ["admin event", "bonus event"], adminOnly: true },
