...
export function HomePanel(props: HomePanelProps) {
  ...
  const copy =
    props.lang === "tr"
      ? {
          heroBody: "Oyuncu hub'ı burada rapor okumaz. Seni direkt bir sonraki oynanabilir hamleye iter.",
          arenaHint: "arena açık",
          missionHint: "claim hazır",
          vaultHint: "wallet route",
          discoverHint: "yeni rota",
          nextMoveTitle: "Sonraki hamle",
          nextMoveBodyMissions: "Claim hazır görevleri kapat, streak'i koru ve günlük cap'i ilerlet.",
          nextMoveBodyVault: "Wallet hattını aç, payout penceresini kontrol et ve ödül rotasını temizle.",
          nextMoveBodyArena: "Arena'ya dön, ladder baskısını kur ve sezon puanını yukarı çek.",
          nextMoveBodyDiscover: "Bot'un öne çıkardığı hızlı rotayı çalıştır ve bir sonraki lane'e zıplat.",
          nextMoveLabelMissions: "Görev hattı",
          nextMoveLabelVault: "Vault hattı",
          nextMoveLabelArena: "Arena hattı",
          nextMoveLabelDiscover: "Hızlı rota",
          seasonChainTitle: "Sezon koşu zinciri",
          seasonChainBody: "Giriş hub'ı seni arena baskısına yollar, oradan mission claim ve sonunda vault çıkışına bağlar.",
          seasonChainHome: "Hub uyanış",
          seasonChainHomeBody: "Bugünün streak, wallet ve hızlı route kararı burada verilir.",
          seasonChainArena: "Arena baskısı",
          seasonChainArenaBody: "Duel ve ladder sonucu sonraki claim baskısını belirler.",
          seasonChainMission: "Görev kapanışı",
          seasonChainMissionBody: "Hazır objective kapanır ve ödül rotası açılır.",
          seasonChainVault: "Vault çıkışı",
          seasonChainVaultBody: "Proof, payout ve prize market sezon koşusunu tamamlar.",
          stateLive: "canlı",
          stateQueued: "sırada",
          stateReady: "hazır",
          stateComplete: "tamam",
          ...
          signalTotal: "toplam",
          signalPasses: "pass",
          hintTitle: "Hızlı rota kartları",
          hintBody: "Bot'un önerdiği bir sonraki lane veya komut buradan açılır.",
          rhythmTitle: "Bugünün ritmi",
          rhythmBody: "Günlük loop, wallet ve premium hattını tek bakışta oku.",
          goalsTitle: "Anlık hedefler",
          goalsBody: "Şimdi kapatman gereken görevler burada.",
          supportTitle: "Ödül bayı",
          supportBody: "Ödüller, premium etkiler ve hızlı destek hareketleri burada.",
          walletLive: "wallet hazır",
          walletIdle: "wallet bekliyor",
          seasonRun: "sezon koşusu",
          readyWord: "hazır"
        }
      : {
