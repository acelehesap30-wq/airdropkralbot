...
export function PvpPanel(props: PvpPanelProps) {
  ...
  const copy = {
    heroBody: t(props.lang, "pvp_hero_body"),
    routeTitle: t(props.lang, "pvp_route_title"),
    routeStartBody: t(props.lang, "pvp_route_start_body"),
    routeStrikeBody: t(props.lang, "pvp_route_strike_body"),
    routeResolveBody: t(props.lang, "pvp_route_resolve_body"),
    routeBoardBody: t(props.lang, "pvp_route_board_body"),
    routeLabelStart: t(props.lang, "pvp_route_label_start"),
    routeLabelStrike: t(props.lang, "pvp_route_label_strike"),
    routeLabelResolve: t(props.lang, "pvp_route_label_resolve"),
    routeLabelBoard: t(props.lang, "pvp_route_label_board"),
    chainTitle: t(props.lang, "pvp_chain_title"),
    chainBody: t(props.lang, "pvp_chain_body"),
    chainArena: t(props.lang, "pvp_chain_arena"),
    chainArenaBody: t(props.lang, "pvp_chain_arena_body"),
    chainMission: t(props.lang, "pvp_chain_mission"),
    chainMissionBody: t(props.lang, "pvp_chain_mission_body"),
    chainVault: t(props.lang, "pvp_chain_vault"),
    chainVaultBody: t(props.lang, "pvp_chain_vault_body"),
    stateLive: t(props.lang, "pvp_state_live"),
    stateQueued: t(props.lang, "pvp_state_queued"),
    stateReady: t(props.lang, "pvp_state_ready"),
    stateLocked: t(props.lang, "pvp_state_locked"),
    signalAccept: t(props.lang, "pvp_signal_accept"),
    signalWin: t(props.lang, "pvp_signal_win"),
    routeSideTitle: t(props.lang, "pvp_route_side_title"),
    routeSideBody: t(props.lang, "pvp_route_side_body"),
    missionsExit: t(props.lang, "pvp_missions_exit"),
    vaultExit: t(props.lang, "pvp_vault_exit"),
    leaderboardExit: t(props.lang, "pvp_leaderboard_exit"),
    clashTitle: t(props.lang, "pvp_clash_title"),
    clashBody: t(props.lang, "pvp_clash_body"),
    duelTitle: t(props.lang, "pvp_duel_title"),
    duelBody: t(props.lang, "pvp_duel_body"),
    ladderTitle: t(props.lang, "pvp_ladder_title"),
    ladderBody: t(props.lang, "pvp_ladder_body"),
    bossTitle: t(props.lang, "pvp_boss_title"),
    bossBody: t(props.lang, "pvp_boss_body"),
    leaderboardTitle: t(props.lang, "pvp_leaderboard_title"),
    leaderboardBody: t(props.lang, "pvp_leaderboard_body"),
    clashHistoryTitle: t(props.lang, "pvp_clash_history_title"),
    clashHistoryBody: t(props.lang, "pvp_clash_history_body"),
    liveWord: t(props.lang, "pvp_live_word"),
    queueWord: t(props.lang, "pvp_queue_word"),
  };
